---
name: vscode-local-setup
description: Run, debug, and troubleshoot the OpenHands Tab VS Code extension in a local Extension Development Host. Use when setting up VS Code locally, rebuilding or reloading the extension, collecting webview or extension logs, or taking screenshots.
---
