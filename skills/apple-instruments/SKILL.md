...
description: Profile, debug, and inspect macOS apps and processes from the CLI using xctrace, leaks, sample, fs_usage, powermetrics, and xcodebuild. Use when diagnosing macOS performance, memory, hangs, file I/O, networking, energy, launch time, SwiftUI, or Xcode build/test issues.
---
