---
name: vscode-remote-setup
description: Set up and operate VS Code in a headless remote environment with Xvfb, Fluxbox, x11vnc, and noVNC. Use when testing the OpenHands Tab extension in remote sandboxes, starting or stopping noVNC services, or capturing headless screenshots.
---
